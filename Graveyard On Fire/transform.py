...
newImg = cv2.imread("transformFinal.jpg")
...
newImg = cv2.undistort(newImg, mtx, dist, None, newcameramtx)
cv2.circle(img, (280, 53), 7, (0, 0, 0), -1)  #cover up
pts = np.array([(280, 53), (400, 52), (530, 172), (132, 164)], dtype = "float32")
width = int(math.sqrt(((172-164) ** 2) + ((530-132) ** 2)))
width2 = 400 - 280
height = int(math.sqrt(((172-53) ** 2) + ((532-400) ** 2)))
pts = np.array([(104, 193), (383, 197), (626, 340), (8
realWidth = 8.5 + 5.5
realHeight = 83.5 - 24.5
#print "realWidth"
#print realWidth
print "realHeight"
print realHeight
...
"""
cv2.circle(img, (280, 53), 2, (100, 255, 255), -1)  #yellow first point
cv2.circle(img, (400, 53), 2, (255, 0, 0), -1)  #blue second point
cv2.circle(img, (530, 172), 2, (0, 255, 0), -1)  #green third point
cv2.circle(img, (132, 164), 2, (0, 0, 255), -1)  #red last point
"""

cv2.circle(img, (340, 80), 6, (255, 0, 255), -1) #middle
cv2.circle(img, (280, 83), 2, (255, 0, 255), -1) #middle
cv2.line(img, (132, 164), (400, 53), (0, 0, 0), 2)
cv2.line(img, (280, 53), (530, 172), (0, 0, 0), 2)
cv2.line(img, (280, 53), (400, 53), (0, 165, 255), 2)
cv2.line(img, (132, 164), (530, 172), (0, 165, 255), 2)
cv2.line(img, (280, 53), (132, 164), (0, 165, 255), 2)
cv2.line(img, (400, 53), (530, 172), (0, 165, 255), 2)
